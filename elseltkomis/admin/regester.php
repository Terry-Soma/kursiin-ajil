				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg']=""; ?></p>
							...
							<div class="col-sm-10">
								<input type="number" class="form-control" value=""  name="bdugaar" required >
							</div>
						</div>  
                        <div class="form-group">
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
								<input type="mail" class="form-control" value="" name="email"  >
							</div>
						</div>	
								

						<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Нууц үг </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								...
								<div class="col-sm-10">
								<input type="digit" class="form-control" value="" name="contact"  required>
							</div>
						</div>
                        <div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Гэрчилгээний дугаар </label>
								<div class="col-sm-10">
								<input type="digit" class="form-control" value="" name="gdugaar"  required>
							</div>
						</div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Зураг </label>
							<div class="col-sm-10">
								<input type="text" class="form-control" value=""  name="fname" required >
							</div>
						</div>
